...
export function AppointmentDetails() {
    const [widget, setWidget] = useState<GuildWidget>({} as GuildWidget);  //GuildWidget>({} as GuildWidget) objeto vazio
    const [loading, setLoading] = useState(true);

    const route = useRoute();
    const { guildSelected } = route.params as Params;

    async function fetchGuildWidget() {  //exibe a quantidade de jogadores dinamicamente
        try {
